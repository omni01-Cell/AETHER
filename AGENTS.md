...
## Decisions made
- [YYYY-MM-DD] Chose X over Y because [reason] (keep all decision make not delete)
...
dont forget use graphify in coding, for global viewn on all file interaction and dependance.